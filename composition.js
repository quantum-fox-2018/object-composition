...
class CookieFactory {
    ...
    static create(option) {
        ...
        // console.log(splitOption3)
        // for (let i = 0; i < optionArr.length; i++) {
            
        //     if (optionArr[i] === 'peanut butter') {

        //         let peanutButter = new PeanutButter(optionArr[i], 'mentah', [])
                
        //         resultArr.push(peanutButter)
        //     } else if (optionArr[i] === 'chocolate chip') {

        //         let chocholateChip = new ChocholateChip(optionArr[i], 'mentah', [])

        //         resultArr.push(chocholateChip)
        //     } else {

        //         let other = new Other(optionArr[i], 'mentah', [])
    ...
    static cookieRecommendation(day, cookies) {
        ...
        for (let i = 0; i < this._cookies.length; i++) {
            ...
            // console.log(this._cookies[i].name)
